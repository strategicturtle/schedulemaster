...
const EN: Dict = {
  ...
  "grid.builtByYou": "Built by you",
  "grid.emptyManual": "Empty week — double-tap any empty slot to add your first block.",
  "lobby.newBlank": "Build my own",
  "lobby.blankTip": "Start from an empty week and add everything yourself.",
  ...
  "grid.done": "Done",
  "grid.delete": "Delete",
  "grid.duplicateBlock": "Duplicate block",
  "grid.close": "Close",
  "block.new": "New block",
...
const ES: Dict = {
  ...
  "grid.builtByYou": "Creado por ti",
  "grid.emptyManual": "Semana vacía — toca dos veces un hueco para añadir tu primer bloque.",
  "lobby.newBlank": "Crear el mío",
  "lobby.blankTip": "Empieza con una semana vacía y añade todo tú mismo.",
  ...
  "grid.duplicateBlock": "Duplicar bloque",
  "grid.close": "Cerrar",
...
const FR: Dict = {
  ...
  "grid.builtByYou": "Créé par toi",
  "grid.emptyManual": "Semaine vide — double-clique sur un créneau pour ajouter ton premier bloc.",
  "lobby.newBlank": "Créer le mien",
  "lobby.blankTip": "Pars d’une semaine vide et ajoute tout toi-même.",
  ...
  "grid.duplicateBlock": "Dupliquer le bloc",
  "grid.close": "Fermer",
...
const ZH: Dict = {
  ...
  "grid.builtByYou": "由你创建",
  "grid.emptyManual": "空白的一周——双击任意空位来添加第一个日程块。",
  "lobby.newBlank": "自己创建",
  "lobby.blankTip": "从空白的一周开始，全部由你自己添加。",
